// 인텔리제이 커뮤니티에서는 JS지원 안한다.
// [1] 인텔리제이 얼티메이터 유료버전, 비권장
// [2] 인텔리제이 플로그인에서 모든 언어 자동AI 추천, 교육상 비권장
// [3] VSCODE( html/css/js) 켜기
console.log("JS실행2");

// VSCODE 코드 작서이 인텔리지제이에도 +반영+된다.
// VSCODE 에서 HTML?JS코드를 작성하고 SPRING 서버 실행은 인텔리제이에서 하자.

// 1] JS 자료/값
console.log( 3 ); console.log( 3.14 ); console.log( true );
console.log( null ); console.log( undefined );
console.log( "안녕1" ); console.log("안녕2"); console.log(`안녕3`); //`백틱
...
// 6]**람다식(화살표) 함수 선언 , function키워드를 => 화살표 이용한 표현식, 단]일회성 함수
const func3 = ( a , b ) => { console.log( 'func3 exe' ); }
